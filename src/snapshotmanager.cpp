...
SnapshotManager::SnapshotManager(MainWindow* mainWindow,
                                 Stream* stream) :
    _menu(tr("&Snapshots")),
    _takeSnapshotAction(tr("&Take Snapshot"), this),
    loadSnapshotAction(tr("&Load Snapshots"), this),
    clearAction(tr("&Clear Snapshots"), this)
{
    _mainWindow = mainWindow;
    _stream = stream;

    _takeSnapshotAction.setToolTip(tr("Take a snapshot of current plot"));
    ...
    clearAction.setToolTip(tr("Delete all snapshots"));
