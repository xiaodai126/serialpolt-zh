...
PlotMenu::PlotMenu(QWidget* parent) :
    ...
    showGridAction(tr("&Grid"), this),
    showMinorGridAction(tr("&Minor Grid"), this),
    unzoomAction(tr("&Unzoom"), this),
    darkBackgroundAction(tr("&Dark Background"), this),
    showLegendAction(tr("&Legend"), this),
    showMultiAction(tr("Multi &Plot"), this),
    setSymbolsAction(tr("&Symbols"), this),
    setSymbolsAutoAct(tr("Show When &Zoomed"), this),
    setSymbolsShowAct(tr("Always &Show"), this),
    setSymbolsHideAct(tr("Always &Hide"), this),
    setLegendPosAction(tr("Legend Position"), this),
    legendPosGrp(this),
    setLegendTopLeftAct(tr("Top Left"), this),
    setLegendTopRightAct(tr("Top Right"), this),
    setLegendBottomRightAct(tr("Bottom Right"), this),
    setLegendBottomLeftAct(tr("Bottom Left"), this)
{
    showGridAction.setToolTip(tr("Show Grid"));
    showMinorGridAction.setToolTip(tr("Show Minor Grid"));
    unzoomAction.setToolTip(tr("Unzoom the Plot"));
    darkBackgroundAction.setToolTip(tr("Enable Dark Plot Background"));
    showLegendAction.setToolTip(tr("Display the Legend on Plot"));
    showMultiAction.setToolTip(tr("Display All Channels Separately"));
    setSymbolsAction.setToolTip(tr("Show/Hide symbols"));
